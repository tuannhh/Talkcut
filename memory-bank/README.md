...
- [Distribution](distribution.md): bộ cài tự thiết lập Docker và cấu hình máy dự kiến.
...
Application root is this repository. Local URL: http://localhost:8092. Private GitHub: https://github.com/tuannhh/Talkcut. Reference project `/Users/tuanbui/ai-motion-studio` is read-only context, not this application's root.
